...
void Print_fprintEtherHeader(FILE *fp, const struct ether_header* const header) {
  fprintf(fp, "Ether Header\n");

  fprintf(fp, "src: ""%02"PRIx8":%02"PRIx8":%02"PRIx8":%02"PRIx8":%02"PRIx8":%02"PRIx8"\n",
  ...
  fprintf(fp, "dst: ""%02"PRIx8":%02"PRIx8":%02"PRIx8":%02"PRIx8":%02"PRIx8":%02"PRIx8"\n",
  ...
  case ETH_P_IP    : fprintf(fp, "IP\n");      break;
  case ETH_P_IPV6  : fprintf(fp, "IPv6\n");    break;
  case ETH_P_ARP   : fprintf(fp, "ARP\n");     break;
